...
CONFIG_FILE=${SIGMAP_DIR}/config/drl_T_hallway.yaml
...
${BLENDER_APP} -b ${BLENDER_DIR}/models/hallway_T.blend --python ${SIGMAP_DIR}/sigmap/blender_script/install_mitsuba_addon.py
