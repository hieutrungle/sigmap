...
CONFIG_FILE=${SIGMAP_DIR}/config/drl_T_hallway_3.yaml
...
${BLENDER_APP} -b ${BLENDER_DIR}/models/hallway_T_3.blend --python ${SIGMAP_DIR}/sigmap/blender_script/install_mitsuba_addon.py -- --blender_app ${BLENDER_APP}
...
python ${SIGMAP_DIR}/sigmap/drl_wireless_main.py --command train -dcfg ${SIGMAP_DIR}/config/drl_T_beamfocusing_3.yaml -scfg ${CONFIG_FILE} -v $DEVICE_CONFIG
python ${SIGMAP_DIR}/sigmap/drl_wireless_main.py --command eval -dcfg ${SIGMAP_DIR}/config/drl_T_beamfocusing_3.yaml -scfg ${CONFIG_FILE} -v $DEVICE_CONFIG
