...
CONFIG_FILE=${SIGMAP_DIR}/config/drl_T_hallway_1.yaml
...
${BLENDER_APP} -b ${BLENDER_DIR}/models/hallway_T_1.blend --python ${SIGMAP_DIR}/sigmap/blender_script/install_mitsuba_addon.py -- --blender_app ${BLENDER_APP}
