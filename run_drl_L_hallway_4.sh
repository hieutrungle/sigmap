...
CONFIG_FILE=${SIGMAP_DIR}/config/drl_L_hallway_4.yaml
...
${BLENDER_APP} -b ${BLENDER_DIR}/models/hallway_L_4.blend --python ${SIGMAP_DIR}/sigmap/blender_script/install_mitsuba_addon.py -- --blender_app ${BLENDER_APP}
...
python ${SIGMAP_DIR}/sigmap/drl_wireless_main.py --command train -dcfg ${SIGMAP_DIR}/config/drl_L_beamfocusing_4.yaml -scfg ${CONFIG_FILE} -v $DEVICE_CONFIG
python ${SIGMAP_DIR}/sigmap/drl_wireless_main.py --command eval -dcfg ${SIGMAP_DIR}/config/drl_L_beamfocusing_4.yaml -scfg ${CONFIG_FILE} -v $DEVICE_CONFIG
